...
- توجه : اگر هنگام دانلود یا نصب ارور ویروس گرفتید به دلیل Read و Write  بر روی  فایل `custom_dns.json` هست. میتونید آنتی ویروس رو برای این برنامه غیر فعال کنید تا بدون مشکل استفاده کنید و یا موقتا از نسخه 2.2 استفاده کنید تا مشکل حل شود بار دیگر عرض میکنیم کد های برنامه موجود هست و میتونید تمام کد ها رو بررسی کنید.
