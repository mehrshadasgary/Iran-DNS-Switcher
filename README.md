...
- شامل DNS های محبوب داخلی و بین‌المللی (بیش از 20 دی ان اس)
- گزینه بازگشت DNS به حالت دیفالت (DHCP)  
-  قابلیت اسکن کردن url : اسکن DNS ها برای اینکه بفهمید کدام DNS میتواند به سایت مورد نظر دسترسی داشته باشد
